					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							...
							<div class="d-none d-lg-flex align-items-center mr-3">
								...
								<a href="index.php">
									<h2 style="padding-left: 13px;padding-top: 7px;color: #6FCF97"">PhoneBook</h2>
								</a>
								<!--end::Logo-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								<span class="text-muted font-weight-bold mr-2">2020©</span>Jawad Al-Saeed</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark order-1 order-md-2">
								<a href="https://github.com/JawadAlSaeed/PhoneBook-Project" target="_blank" class="nav-link pr-3 pl-0">Github</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
